            ...
            <div id="content-wrap">
               <h1><c:out value="${success}"></c:out></h1>
                ...
                <table class="table table-striped table-hover table-responsive">
                	<thead>
                	<tr>
                		<td>Username</td><td>Account Number</td> <td>Balance</td> <td>Type</td><td>State</td><td>Decide</td>
                	</tr>
                	</thead>
                	<tbody>
